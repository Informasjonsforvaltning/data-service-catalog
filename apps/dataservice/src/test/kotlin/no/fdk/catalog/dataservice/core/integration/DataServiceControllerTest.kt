package no.fdk.catalog.dataservice.core.integration

import no.fdk.catalog.common.jsonpatch.JsonPatchOperation
import no.fdk.catalog.common.jsonpatch.OpEnum
import no.fdk.catalog.common.jsonpatch.PatchRequest
import no.fdk.catalog.dataservice.config.JacksonConfig
import no.fdk.catalog.dataservice.config.SecurityConfig
import no.fdk.catalog.dataservice.core.controller.DataServiceController
import no.fdk.catalog.dataservice.core.domain.*
import no.fdk.catalog.dataservice.core.exception.BadRequestException
import no.fdk.catalog.dataservice.core.exception.NotFoundException
import no.fdk.catalog.dataservice.core.handler.DataServiceHandler
...
class DataServiceControllerTest(@Autowired val mockMvc: MockMvc) {
    ...
    fun `publish should respond with bad request on exception`() {
        ...
        handler.stub {
            ...
            } doThrow BadRequestException("Data Service $dataServiceId already published")
        }
    ...
    fun `unpublish should respond with bad request on exception`() {
        ...
        handler.stub {
            ...
            } doThrow BadRequestException("Data Service $dataServiceId not published")
        }
